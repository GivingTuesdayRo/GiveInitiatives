...
namespace GiveInitiatives\Library\Autoload;

/**
 * Class Autoload
 * @package GiveInitiatives\Library\Autoload
 */
class Autoload
{
    private $cachedPaths = [];
    ...
    {
        // Not a GiveInitiatives file, early exit.
        if (0 !== stripos($className, 'GiveInitiatives')) {
            return;
        }
    ...
    {
        $className = str_replace('GiveInitiatives', '', $className);
